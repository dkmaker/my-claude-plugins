...
When removing backgrounds from images generated by `image:generate-image` (or similar AI tools):
...
See the `image:generate-image` skill for chroma key color selection rules.
