...
- For **version-specific library API docs**, prefer Context7 (`mcp__plugin_websearch_context7__resolve-library-id` → `mcp__plugin_websearch_context7__query-docs`) over websearch — it pulls from official docs and is more accurate for specific API questions
